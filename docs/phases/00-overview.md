...
| Phase 1 | [phase-1-orchestration.md](./phase-1-orchestration.md) | 编排与工作台：Pipeline、Dashboard | 3-4 周 |
...
- **Phase 1**：Dashboard 展示任务、手动触发后 Pipeline 完成 parse→plan→execute→update 全流程
